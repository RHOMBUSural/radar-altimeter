...
class RadarAltimeterGUI:
    def __init__(self, root):
        ...
        self.show_signal_var = tk.BooleanVar(value=False)
    ...
    def show_3d_landscape(self):
        """Отображение 3D визуализации ландшафта"""
